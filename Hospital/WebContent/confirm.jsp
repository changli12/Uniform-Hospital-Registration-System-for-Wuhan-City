...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    import="object.Reserveconfirm" pageEncoding="UTF-8"%>
...
<%
	...
	if(request.getSession().getAttribute("resfirm")!=null)
	{
	 	resfirm=(Reserveconfirm)session.getAttribute("resfirm");
	}
%>
<div class="logo">
  ...
  <tr>
    <td><a href="#" onClick="back()">返回上一页</a><a href="Reserveinsert"><input style="float:right" name="confirm" type="button" value="确认"></a></td>
  </tr>
</table>
